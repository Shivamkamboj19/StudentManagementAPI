...
public static class StudentManagementAPIEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE StudentManagementAPIModuleExtensionConfigurator CLASS (in the Domain.Shared project)
